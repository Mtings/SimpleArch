...
public final class NotificationUtil {
    ...
    private static void afterO(NotificationManager manager) {
        ...
        if (channel == null) {
            ...
            channel = new NotificationChannel(DEFAULT_CHANNEL_ID, DEFAULT_CHANNEL_NAME,
...
//            channel.enableVibration(true);
    ...
    @NonNull
    private static DownloadManager requireManagerNotNull() {
        if (DownloadManager.Companion.getManager() == null) {
            return new DownloadManager();
        }
        return DownloadManager.Companion.getManager();
    }
}
